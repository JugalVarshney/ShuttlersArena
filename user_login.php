...
<html lang="en">
    ...
    <body class="bg-primary" style="background-image: linear-gradient(#f5d654, #ffffff)">
...
<a class="small" href="./admin_index.php">Admin Login</a>
<button class="btn btn-primary" name="login" type="submit">Login</button>
</div>
</form>
</div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="./user_signup.php">Need an account? Sign up!</a></div>
